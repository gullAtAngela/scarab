...
<script type="text/html" id="ABTemplate-DE" >
<![CDATA[
...
<div class="scarab-itemlist">
	...
	<span data-scarabitem="{{= p.id }}" class="scarab-item">
		...
		<span class="prices">
			<span class="price">ab&nbsp;CHF&nbsp;{{= p.price.toFixed(2) }}</span>
			{{ if(p.msrp != 0) { }}
				<span class="price-old">statt CHF&nbsp;{{=p.msrp}}</span>
			{{ } }}
		</span>
	</span>
	{{ } }}
...
{{ } else { }}
	<div class="callout warning">
		<h5>Keine passende Empfehlung</h5>
		<p>Bitte überprüfe die Warengruppe.</p>
	</div>
{{ } }}
]]>
</script>
